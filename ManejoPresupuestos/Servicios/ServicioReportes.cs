...
namespace ManejoPresupuestos.Servicios
{
    ...
    public class ServicioReportes: IServicioReportes
    {
        ...
        private static ReporteTransaccionesDetalladas GenerarMetodoTransaccionesDetalladas(DateTime fechaInicio, DateTime fechaFin, IEnumerable<Transaccion> transacciones)
        {
            var modelo = new ReporteTransaccionesDetalladas();

            var transaccionesPorFecha = transacciones.OrderByDescending(x => x.FechaTransaccion)
                                                                .GroupBy(x => x.FechaTransaccion)
                                                                .Select(grupo => new ReporteTransaccionesDetalladas.TrasaccionesPorFecha
                                                                {
