namespace ManejoPresupuestos.Models
{
    public class ReporteTransaccionesDetalladas
    {
        ...
        public IEnumerable<TrasaccionesPorFecha> TransaccionesAgrupadas { get; set; }
        public decimal BalanceDepositos => TransaccionesAgrupadas.Sum(x => x.BalanceDepositos);
        public decimal BalanceRetiro => TransaccionesAgrupadas.Sum(x => x.BalanceRetiros);
        public decimal Total => BalanceDepositos - BalanceRetiro;

        public class TrasaccionesPorFecha 
        { 
